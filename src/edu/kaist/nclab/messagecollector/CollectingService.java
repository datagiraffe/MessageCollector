...
//		for (RunningTaskInfo rap : list) {
//			// Log.e(rap.baseActivity.getPackageName().toString());
//			for (int i = 0; i < packageName.length; i++) {
//				// Log.e("PACKAGE NAME : " + packageName[i]);
//				if (rap.baseActivity.getPackageName().toString()
//						.contains(packageName[i])) {
//					isRunning = true;
//					break;
//				}
//			}
